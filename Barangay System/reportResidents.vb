...
Public Class reportResidents
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Barangay_System.reportResidents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreportResidents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportResidents = New reportResidents()
        rpt.Site = Me.Site
        Return rpt
    End Function
